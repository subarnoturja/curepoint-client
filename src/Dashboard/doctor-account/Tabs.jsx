...
const Tabs = ({ tab, setTab }) => {
    ...
    return (
        <div>
            <span className="md:hidden"><BiMenu className="w-6 h-6 cursor-pointer" /></span>
           <div className="hidden md:flex flex-col p-[30px] bg-white shadow-panelShadow items-center h-max rounded-md">
                ...
                <button
                  ...
                  className="w-full bg-[#181A1E] p-3 text-[16px] leading-7 rounded-md text-white text-lg"
                >
                  Logout
                </button>
                <button className="w-full bg-red-600 mt-4 p-3 text-[16px] leading-7 rounded-md text-white text-lg">
                  Delete Account
                </button>
              </div>
           </div>
